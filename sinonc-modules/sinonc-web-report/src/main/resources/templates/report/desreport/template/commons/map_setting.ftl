        ...
        <Submenu name="10" style="border-bottom: inset 1px;">
            ...
            <div class="blockDiv">
                ...
                <Row class="ivurow" v-if="typeof mapOption.label_color !== 'undefined'">
                    <p>字体颜色&nbsp;&nbsp;</p>
                    <Col><color-picker class="colorPicker" size="small" v-model="mapOption.label_color" @on-change="onGeoChange" transfer/></Col>
                </Row>
                <Row class="ivurow" v-if="typeof mapOption.emphasis_label_color !== 'undefined'">
                    <p>字体高亮颜色&nbsp;&nbsp;</p>
                    <Col><color-picker class="colorPicker" size="small" v-model="mapOption.emphasis_label_color" @on-change="onGeoChange" transfer/></Col>
                </Row>
                <Row class="ivurow">
                    <p>区域线&nbsp;&nbsp;</p>
                ...
                <Row class="ivurow" v-if="typeof mapOption.itemStyle_areaColor !== 'undefined'">
                    <p>区域颜色&nbsp;&nbsp;</p>
                    <Col><color-picker class="colorPicker" size="small" v-model="mapOption.itemStyle_areaColor" @on-change="onGeoChange" transfer/></Col>
                </Row>
                <Row class="ivurow" v-if="typeof mapOption.emphasis_itemStyle_areaColor !== 'undefined'">
                    <p>区域高亮颜色&nbsp;&nbsp;</p>
                    <Col><color-picker class="colorPicker" size="small" v-model="mapOption.emphasis_itemStyle_areaColor" @on-change="onGeoChange" transfer/></Col>
                </Row>
                <Row class="ivurow" v-if="typeof mapOption.itemStyle_borderColor !== 'undefined'">
                    <p>边框颜色&nbsp;&nbsp;</p>
                    <Col><color-picker class="colorPicker" size="small" v-model="mapOption.itemStyle_borderColor" @on-change="onGeoChange" transfer/></Col>
                </Row>
            </div>
        </Submenu>
        <#--地图弹窗-->
