...
<body onload="view.loads('${config_id}')">
<div id="app">
    <!-- 查询条件 -begin -->
    ...
    <!-- 查询条件 -end -->
    <div id="x-spreadsheet-demo" style="width:100%;height: 100%"></div>
...
<#--预览js-->
<script type="text/javascript" src="${base}${customPrePath}/jmreport/desreport/js/biz/row.express.js"></script>
<script type="text/javascript" src="${base}${customPrePath}/jmreport/desreport/js/biz/row.cycle.js"></script>
<script type="text/javascript" src="${base}${customPrePath}/jmreport/desreport/js/biz/report_view.js"></script>
</body>
</html>
