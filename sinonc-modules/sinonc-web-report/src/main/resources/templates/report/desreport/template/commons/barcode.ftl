...
<script type="text/x-template" id="barcode-setting-template">
    <div style="height: auto;overflow:hidden;padding-bottom: 200px">
        <i-form label-position="top" class="jm-form-barcode"  >
            ...
            <form-item label="条颜色:">
                <color-picker v-model="lineColor" :transfer="true"  style="width: 200px" class="colorPicker" size="small" @on-change="onBarcodeChange"/>
            </form-item>

            <form-item label="背景色:">
                <color-picker v-model="background" :transfer="true"  style="width: 200px" class="colorPicker" size="small" @on-change="onBarcodeChange"/>
            </form-item>
