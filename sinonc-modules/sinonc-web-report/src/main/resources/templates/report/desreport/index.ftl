...
<head>
    ...
    <link rel="stylesheet" href="${base}${customPrePath}/jmreport/desreport/corelib/report.css">
    <link rel="stylesheet" href="${base}${customPrePath}/jmreport/desreport/corelib/xspreadsheet.css">
    <link rel="shortcut icon" href="${base}${customPrePath}/jmreport/desreport/corelib/logo.png" type="image/x-ico">
    <script src="${base}${customPrePath}/jmreport/desreport/corelib/xspreadsheet.js"></script>
    <script src="${base}${customPrePath}/jmreport/desreport/corelib/locale/zh-cn.js"></script>
    <script src="${base}${customPrePath}/jmreport/desreport/jquery/jquery-3.4.1.min.js"></script>
    <script src="${base}${customPrePath}/jmreport/desreport/cdn/html2canvas/html2canvas.min.js"></script>
    <script src="${base}${customPrePath}/jmreport/desreport/cdn/html2canvas/canvas2image.js"></script>
    <script src="${base}${customPrePath}/jmreport/desreport/js/config/chart_type_list.js"></script>
    <script src="${base}${customPrePath}/jmreport/desreport/js/config/map_type_list.js"></script>
    <!--引入自定义组件-->
            ...
            <div id="tableDiv">
                <Card>
                    <div class="layout-content" style="overflow: auto">
                        <div id="x-spreadsheet-demo" style="overflow:auto"></div>
                    </div>
                </Card>
            </div>
        </div>
            ...
            <div id="propsDiv">
                ...
                <Card style="width: 235px;height: 977px" v-if="propsContentShow">
                    <Tabs size="small" v-model="rightTabName" >
                        ...
                        <!-- 基本设置  -->
                        <tab-pane label="基本" name="name1" :class="'little-input'">
                        ...
                        <tab-pane v-if="chartsflag && !backgroundSettingShow" label="样式" name="name2" :disabled="selectedChartType==='apiUrlType'">
                            <i-menu theme="light" width="auto" style="margin-left: -20px;height: 900px;" :class="menuitemClasses" accordion>
                                ...
                                <!-- 柱体设置 -->
                                <j-bar-setting v-if="barSettings" @change="onSeriesChange" :settings="barSettings" :isMultiChart="isMultiChart"></j-bar-setting>
                                <!-- 线体设置 -->
                                <j-line-setting v-if="lineSettings" @change="onSeriesChange" :settings="lineSettings" :isMultiChart="isMultiChart"></j-line-setting>
                                <!-- 饼图设置-->
                        ...
                        <tab-pane v-if="chartsflag && selectedChartType !== 'map.simple'" label="数据" name="name3" :class="'little-input'">
                            ...
                            <div class="datastyle" v-if="dataSettings.dataType == 'api'">
                                <div class="datastyle">
                                    <p>Api类型:</p>
                                    <i-select v-model="dataSettings.apiStatus" :disabled="selectedChartType==='apiUrlType'">
                            ...
                            <!-- 多维度处理  -->
                            <div class="datastyle" v-if="(dataSettings.dataType == 'sql' || dataSettings.apiStatus == '1') && (selectedChartType == 'mixed.linebar'||selectedChartType == 'bar.stack')|| selectedChartId=='bar.negative'">
                                <p>系列类型:</p>
...
<script>
    ...
    function load() {
        ...
        $jm.excelGet(excel_config_id,(res)=> {
            //加入预览地址
            xs.data.settings.viewUrl = window.location.origin+apis.view+excel_config_id+"?token="+token;
            var str = res.jsonStr;
            if(!str) return;
            //页面加载时设置报表宽度
...
<script type="text/javascript" src="${base}${customPrePath}/jmreport/desreport/js/util.js"></script>
<script type="text/javascript" src="${base}${customPrePath}/jmreport/desreport/js/biz/design.js"></script>
<script>
