<script type="text/x-template" id="match-setting-template">
    <div>
        <Submenu name="19" style="border-bottom: inset 1px;">
            <template slot="title">
                自定义配色
                <Tooltip placement="top" content="建议【边缘颜色】选用比【中心颜色】更深" :transfer="true" v-if="selectedChartType.indexOf('scatter.bubble')!==-1">
