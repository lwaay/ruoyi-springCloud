...
public class IotWarnDto {
    ...
    public JSONArray getInsectDicts() {
        return insectDicts;
    }

    public void setInsectDicts(JSONArray insectDicts) {
        this.insectDicts = insectDicts;
    }
