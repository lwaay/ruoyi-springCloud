package com.sinonc.common.security.aspect;

import com.sinonc.common.core.exception.PreAuthorizeException;
...
public class PreAuthorizeAspect {
    ...
    @Around("@annotation(com.sinonc.common.security.annotation.PreAuthorize)")
